...
class SearchesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create search" do
    assert_difference('Search.count') do
      post searches_url, params: { search: { com: @search.com, exp: @search.exp, ope: @search.ope, tec: @search.tec } }
    end
  ...
  test "should update search" do
    patch search_url(@search), params: { search: { com: @search.com, exp: @search.exp, ope: @search.ope, tec: @search.tec } }
